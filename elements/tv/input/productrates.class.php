...
class TemplateProductRatesInputRender extends modTemplateVarInputRender {
    public function getTemplate() {
        $path = 'components/sead/';
	    $corePath = $this->modx->getOption('sead.core_path', null, $this->modx->getOption('core_path') . $path);
        return $corePath . 'elements/tv/tpl/productrates.html';    
    }
...
return 'TemplateProductRatesInputRender';
